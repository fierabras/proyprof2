 ...
 * @author paco
 */
public class MiniConsultaMateriales extends javax.swing.JDialog {

    private MaterialBO materialBO = new MaterialBO();
    private String clave;

    public MiniConsultaMateriales(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        materialBO.cargarTabla(tablaConsulta, this.campoBuscar.getText());
